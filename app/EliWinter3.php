...
<body onload="toggleZoomScreen()">
 ...
 function toggleZoomScreen() {
  ...
  function HelpAlert(e)
        {
          alert("In the current statement, what is the Annual Percentage Rate for purchases?");
        }
       ...
       var t = 0;
        ...
        function saveTime(time,ans) {
            ...
            if(t>0){
                ...
                xmlhttp.open("POST", "question3_send.php", true);
...
<div style="position:absolute;left:370.15px;top:576.67px" class="cls_002"><span id = "200" class="cls_002" onclick = "stopTimer(this),setColor(event)"; data-count="1">16.99%</span></div>
...
<BUTTON onclick = "window.location.href='question4.php'" style="position: fixed;right:10px; bottom: 20px;" >Next</BUTTON>
</body>
</html>
