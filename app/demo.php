...
<body onload="toggleZoomScreen()">
   ...
   <br><br><br>
   <center>
      <a href="demo.php" class="button" style="color:white"><span> Next </span></button>
   </center></a>
   <div style="position:absolute;left:50%;margin-left:-121px;top:0px;width:243px;height:153px;border-style:outset;overflow:hidden">
      <div style="position:absolute;left:0px;top:0px">
         <img src="Background/background1.jpg" width=243 height=153>
      </div>
      ...
      <div style="position:absolute;left:175.20px;top:91.05px" class="cls_007"><span id="9" class="cls_007" onclick="setColor(this)" ;>Street 1, New York City</span></div>
