...
function toggleZoomScreen() {
   ...
   function HelpAlert(e)
        {
          alert("In the current statement, what is the available Cash Advance Line?");
        }
       ...
       var t = 0;
        ...
        function saveTime(time,ans) {
            ...
            if(t>0){
                ...
                xmlhttp.open("POST", "question2_send.php", true);
...
<BUTTON onclick = "window.location.href='question3.php'" style="position: fixed;right:10px; bottom: 20px;" >Next</BUTTON>
</body>
</html>
