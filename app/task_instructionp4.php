...
<body>
      ...
      <div class="inst-box">
        <h4>
          <center><b>
              ...
              <b><span style="color: #8A2908;">This is <?php echo ($formid === "B") ? "Eli Winters'" : "Pat Miller’s"; ?> credit card statement. <br><br><br><?php echo ($formid === "B") ? "Eli'" : "Pat"; ?> is 64 years old and lives in New York City. <br><br><br>During this statement period, Pat did not travel outside New York City and incurred regular everyday expenses.</span><br><br><br></b>
  ...
  <br>
  <center>
    <a href="task_instructionp5.php" class="button" style="color:white"><span> Next </span></button>
  </center></a>
  <script>
