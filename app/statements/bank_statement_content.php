    ...
    <div class="statement_content">
        <div style="position:absolute;left:50%;margin-left:-306px;top:0px;width:612px;height:792px;border-style:outset;overflow:hidden" data-count="0">
            ...
            <div onclick="stopTimer(this),setColor(event)" ; data-count="0">
                ...
                <div style="position:absolute;left:266.35px;top:497.15px" class="cls_002"><span class="cls_002">$900.00<span hidden=true>(total cash advance line)</span></span></div>
            </div>
            ...
            <div class="possible_answer" id="2" onclick="stopTimer(this),setColor(event)" ; data-count="0">
                ...
                <div style="position:absolute;left:266.35px;top:521.17px" class="cls_002"><span class="cls_002">$900.00<span hidden=true>(available for cash)</span></span></div>
            </div>
        ...
        <div style="position:absolute;left:50%;margin-left:-306px;top:1604px;width:612px;height:792px;border-style:outset;overflow:hidden">
            ...
            <div style="position:absolute;left:370.15px;top:604.95px" class="cls_002"><span class="cls_002" onclick="stopTimer(this),setColor(event)" ; data-count="1">-</span></div>
            <div style="position:absolute;left:446.67px;top:604.95px" class="cls_002"><span class="cls_002" onclick="stopTimer(this),setColor(event)" ; data-count="1">-</span></div>
            <div style="position:absolute;left:514.20px;top:604.95px" class="cls_002"><span class="cls_002" onclick="stopTimer(this),setColor(event)" ; data-count="1">-</span></div>
            <div onclick="stopTimer(this),setColor(event)" ; data-count="0">
