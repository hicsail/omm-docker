...
function HelpAlert(e)
        {
          alert("What is the opening date of the current statement?");
        }
       ...
       var t = 0;
        ...
        function saveTime(time,ans) {
            ...
            if(t>0){
                ...
                xmlhttp.open("POST", "question7_send.php", true);
...
<span id="200" onclick = "stopTimer(this),setColor(event)"; data-count="1">
...
<BUTTON onclick = "window.location.href='confidence4.php'" style="position: fixed;right:10px; bottom: 20px;" >Next</BUTTON>
</body>
</html>
