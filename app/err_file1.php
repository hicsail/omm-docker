...
<head>
	...
	<link rel="stylesheet" type="text/css" href="change_pdf3.css">
...
<body>
	...
	<div class="col-sm-3 col-md-6 col-lg-4 col-xl-12" id="pdf">
   ...
   width: 220px; height: 65px;" > <div  id = "sep1" onclick = "stopTimer(this), setColor(event)"; data-count="0"/>    Payment Due Date:<b>      10/09/2018</b></div><div  id = "sep3" onclick = "stopTimer(this), setColor(event)"; data-count="0"/>    New Balance: <b>		   $3,421.10</b> </div><div  id = "sep5" onclick = "stopTimer(this), setColor(event)"; data-count="0"/>    Minimum Payment:<b>	     	$83.71 </b></div></span></span><span class="sp3"><div id = "sep8" onclick = "stopTimer(this), setColor(event)"; data-count="0"/><b>  
			...
			<pre><br><span class="sp6" style="font-size: 16px;"><strong> <div  id = "sep15">
...
<table id="table" style="font-family: times; font-size: 13px; left: 2em"; ><tr><th onclick= "stopTimer(this), setColor(event)"; data-count="0"/ style="background: lightgrey; width: 500em; "> If you make no
additional charges 
using this card and each 
month you pay</th> <th style="background: lightgrey; width: 500em;" onclick="stopTimer(this), setColor(event)"; data-count="0"/> You will pay
 off the balance 
 shown on this
 statement in
  about</th>
  <th style="background: lightgrey; width: 500em" onclick="stopTimer(this), setColor(event)"; data-count="0"/>And you will end 
 up paying an 
 estimated total 
of</th>
	</tr>
...
</div><pre></i><div class="p10" style = "left: 900px;">
...
Page 2 of 3</div>
	...
	<pre><div class="col-sm-3 col-md-6 col-lg-4 col-xl-12"><div class="p14" onclick="setColor(event)"; data-count="0"/><table class="t1" style="width:100% "><thead><tr class="r1"><td onclick="stopTimer(this),setColor(event)"; data-count="0"/><b>Interest Charges</td></tr></thead>	
