...
<body>
  ...
  <div class="container-fluid">
        ...
        <div class="inst-box">
          <h3><b>
              <center><br>
                ...
                If you make an error, an <span onclick="showAlert('This is incorrect. Please select another option')" ; style="color:blue">error</span> message will ask you to try another option.<br><br><br>
    ...
    <br>
    <center>
      <a href="instruction_page2.php" class="button" style="color:white"><span> Next </span></button>
    </center></a>
    <script>
