...
<body>
   ...
   width: 220px; height: 65px;" > <div  id = "sep1" onclick = "stopTimer(this), setColor(event)"; data-count="0"/>    Payment Due Date:<b>      10/09/2018</b></div><div  id = "sep3" onclick = "stopTimer(this), setColor(event)"; data-count="0"/>    New Balance: <b>		   $3,421.10</b> </div><div  id = "sep5" onclick = "stopTimer(this), setColor(event)"; data-count="0"/>    Minimum Payment:<b>	     	$83.71 </b></div></span></span><span class="sp3"><div id = "sep8" onclick = "stopTimer(this), setColor(event)"; data-count="0"/><b>  
			...
			<pre><span class="sp5" onclick="stopTimer(this), setColor(event)"; data-count="0"/>
...
<span id="7" onclick="right_ansTimer(this), setColor(event)"; data-count="0"/>Total Credit Line   			                   	      $4,500,00</span><br>
...
<span id="13" onclick="stopTimer(this), setColor(event)"; data-count="0"/> Minimum Payment Due          		                        	       		     $83.72</span>
<br>
...
<table class="t1" >
	<tr class="tr" onclick="setColor(event)"; data-count="0"/>
	<td onclick="stopTimer(this)"> <b><i>  					     												Total Payments and Credits	            		 -544.25</td></i></b>
</tr>
</table>
</div></pre>
		</td>
...
Page 2 of 3</div>
	...
	<div class="page3">
		...
		<div class="p8">
			...
			<table class="t1">
				<tr class="tr">
					<td onclick="setColor(event)" ; data-count="0" /><b><i>
		...
		<div class="p12" onclick="setColor(event)" ; data-count="0" />
		<table class="t1" style="width:100% ">
			<tr class="tr">
				<div id="c1" onclick="stopTimer(this), setColor(event)" ; data-count="0" />Payments and Credits
	</div>
	...
	<pre><div class="p13"  onclick="setColor(event)"; data-count="0"/><table style="width:100% " class="t1"><tr class="r1"><td class="r2" onclick="stopTimer(this)"><center><b>2019 Total Fee and Interest Charges</center></td></tr>
	...
	<pre><div class="col-sm-3 col-md-6 col-lg-4"><div class="p14" onclick="setColor(event)"; data-count="0"/><table class="t1" style="width:100% "><thead><tr class="r1"><td><b>Interest Charges</td></tr></thead>	
...
<a href="task_instruction2.php" onclick="" >Next</a>
</tbody>
</table>
